...
{
    [DbContext(typeof(OnlineInterviewDbContext))]
    [Migration("20260304014317_CreateTable_Samples")]
    partial class CreateTable_Samples
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Everbot.OnlineInterview.Samples.Sample", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id")
                    ...
                    b.Property<DateTime>("DateTimeWithOutTimeZone")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("date_time_with_out_time_zone");

                    b.Property<DateTimeOffset>("DateTimeWithTimeZone")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("date_time_with_time_zone");
                    ...
                    b.ToTable("samples", t =>
                        {
                            t.HasCheckConstraint("CK_samples_sample_type_Enum", "sample_type IN ('Type1', 'Type2')");
                        });
                });
            ...
            modelBuilder.Entity("Volo.Abp.Identity.IdentityUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastSignInTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_sign_in_time");
            ...
            modelBuilder.Entity("Volo.Abp.PermissionManagement.PermissionDefinitionRecord", b =>
                {
                    ...
                    b.Property<string>("ManagementPermissionName")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("management_permission_name");
                    ...
                    b.HasIndex("ResourceName", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_permissions_resource_name_name");
            ...
            modelBuilder.Entity("Volo.Abp.PermissionManagement.ResourcePermissionGrant", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_resource_permission_grants");

                    b.HasIndex("TenantId", "Name", "ResourceName", "ResourceKey", "ProviderName", "ProviderKey")
                        .IsUnique()
                        .HasDatabaseName("ix_resource_permission_grants_tenant_id_name_resource_name_res~");

                    b.ToTable("resource_permission_grants", (string)null);
                });
