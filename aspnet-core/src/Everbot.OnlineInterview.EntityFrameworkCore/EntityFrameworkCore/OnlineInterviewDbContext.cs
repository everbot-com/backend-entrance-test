using Everbot.OnlineInterview.EntityFrameworkCore.ModelCreatingExtensions;
...
public class OnlineInterviewDbContext : AbpDbContext<OnlineInterviewDbContext>, IOnlineInterviewDbContext
{
    ...
    public OnlineInterviewDbContext(DbContextOptions<OnlineInterviewDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(OnlineInterviewConsts.DbTablePrefix + "YourEntities", OnlineInterviewConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});

        builder.ConfigureSample(Database);
